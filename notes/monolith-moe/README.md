...
| 维度 | 值 |
|---|---|
| **End-to-end super-kernel (DSV3 SPARSE, 8×MI355X)** | **4.82 ms / 598 TFLOPS / 1.76× vs PyTorch+RCCL 8.466 ms**（2026-05-13 Phase 2.1 SwiGLU pre-compute 落地后 8-GPU 实测）—— 比 Phase 2 6.27 ms 再缩 23%，比 README 旧 headline 7.95 ms / 363T / 1.07× 累计缩短 3.13 ms / +65% TFLOPS / +0.69× speedup |
